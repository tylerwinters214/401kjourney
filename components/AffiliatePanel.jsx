...
function AffiliatePanel() {
  ...
  return (
    <div className="mt-8 p-6 bg-white dark:bg-slate-800/50 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700">
      ...
      <div className="mt-6">
        <h3 className="text-sm font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider mb-2">Checking, Savings, and Investing</h3>
      ...
      <div className="mt-6">
        <h3 className="text-sm font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider mb-2">Recommended Reading</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {AFFILIATE_LINKS.books.map(createLink)}
        </div>
      </div>

      <p className="text-xs text-slate-600 dark:text-slate-300 mt-6 text-center">
