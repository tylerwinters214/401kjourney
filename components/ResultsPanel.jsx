    ...
    <div className="p-6 bg-white dark:bg-slate-800/50 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-slate-100 dark:bg-slate-700/50 p-4 rounded-lg text-center">
          <h3 className="text-sm font-medium text-slate-600 dark:text-slate-300 uppercase tracking-wider">Future Nest Egg</h3>
          ...
          <p className="text-xs text-slate-600 dark:text-slate-300 mt-1">Projected value at age {inputs.retirementAge}</p>
        </div>
        <div className="bg-slate-100 dark:bg-slate-700/50 p-4 rounded-lg text-center">
          <h3 className="text-sm font-medium text-slate-600 dark:text-slate-300 uppercase tracking-wider">Nest Egg (Today's $)</h3>
          ...
          <p className="text-xs text-slate-600 dark:text-slate-300 mt-1">Adjusted for inflation & after-tax</p>
        </div>
        <div className="bg-slate-100 dark:bg-slate-700/50 p-4 rounded-lg text-center">
          <h3 className="text-sm font-medium text-slate-600 dark:text-slate-300 uppercase tracking-wider">Est. Monthly Income</h3>
          ...
          <p className="text-xs text-slate-600 dark:text-slate-300 mt-1">After-tax, in today's dollars</p>
        </div>
      </div>
      <h3 className="text-lg font-semibold text-slate-800 dark:text-white mb-2">Savings Growth Over Time</h3>
      <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">This chart shows how your savings could grow, separating your contributions from investment returns.</p>
